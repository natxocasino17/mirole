...
const CORE = [
  ...
  'js/data/sidequests.js', 'js/data/tramas_ev.js', 'js/data/tomo1.js', 'js/data/npcs.js', 'js/data/events2.js', 'js/data/gangs.js', 'js/data/people.js',
  'js/engine/hearts.js', 'js/engine/family.js', 'js/engine/cronista.js', 'js/engine/tramas.js',
  'js/ui/ui.js',
